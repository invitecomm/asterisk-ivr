...
agi.stream_file('wardial/blue00000081')

q1 = question('wardial/blue00000083', '12')
if q1:
    data_insert(db_update % (newTable, 'q1', q1, warlist))

if q1 == '1':

    q2 = question('wardial/blue00000084', '12')
    if q2:
        data_insert(db_update % (newTable, 'q2', q2, warlist))

    if q2 == '1':
        q3 = question('wardial/blue00000085', '12')
        if q3:
            data_insert(db_update % (newTable, 'q3', q3, warlist))

        q4 = question('wardial/blue00000086', '12')
        if q4:
            data_insert(db_update % (newTable, 'q4', q4, warlist))

        q5 = question('wardial/blue00000087', '12')
        if q5:
            data_insert(db_update % (newTable, 'q5', q5, warlist))

        q6 = question('wardial/blue00000088', '12')
        if q6:
            data_insert(db_update % (newTable, 'q6', q6, warlist))
        
        q7 = question('wardial/blue00000089', '12')
        if q7:
            data_insert(db_update % (newTable, 'q7', q7, warlist))        

        q8 = question('wardial/blue00000090', '12')
        if q8:
            data_insert(db_update % (newTable, 'q8', q8, warlist))

agi.stream_file('wardial/blue00000082')
